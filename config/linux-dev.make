...
#TARGET  =	-m32
OPTIONS +=  -std=gnu17 -fdiagnostics-format=sarif-stderr -Werror=conversion -Werror=sign-conversion -Werror=missing-prototypes -Werror=cast-function-type -Werror=shadow -Werror=old-style-definition -Werror=strict-prototypes -Werror=pointer-sign -Werror=pedantic -g -I. -I$(TOPDIR)h $(PEPYPATH) $(KRBOPT)
