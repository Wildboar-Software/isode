...
static int	prob2num (const struct choice_ROS_3 *prob);
static int  apdu_proc (int sd, const struct type_ROS_ROSEapdus *papdu, PE *pe, struct RoSAPindication *roi, const struct assocblk *acb, const int *invokeID);
static int  opdu_proc (int sd, const struct type_ROS_OPDU *popdu, PE *pe, struct RoSAPindication *roi, const struct assocblk *acb, const int *invokeID);

int acb2osdu (struct assocblk *acb, const int *invokeID, PE pe, struct RoSAPindication *roi) {
