...
int PGTokenRequest (int sd, const int tokens, struct PSAPindication *pi) {
	SBV	    smask;
	int     result;
	struct psapblk *pb;
...
int PPTokenRequest (int sd, const int tokens, PE *data, int ndata, struct PSAPindication *pi) {
	SBV	    smask;
	int     len,
			result;
	char   *base,
