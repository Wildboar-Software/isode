...
int	ss2rtslose (struct assocblk *acb, struct RtSAPindication *rti, const char *event, struct SSAPabort *sa), ss2rtsabort (struct assocblk *acb, struct SSAPabort *sa, struct RtSAPindication *rti);
