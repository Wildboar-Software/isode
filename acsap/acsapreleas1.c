...
int AcRelRequest (const int sd, const int reason, PE *data, const int ndata, const int secs, struct AcSAPrelease *acr, struct AcSAPindication *aci) {
	SBV	    smask;
	int	    result;
	struct assocblk *acb;
...
int AcRelRetryRequest (const int sd, const int secs, struct AcSAPrelease *acr, struct AcSAPindication *aci) {
	SBV	    smask;
	int	    result;
	struct assocblk *acb;
