...
static int AcAssocRequestAux (OID context, AEI callingtitle, AEI calledtitle, const struct PSAPaddr *callingaddr, const struct PSAPaddr *calledaddr, struct PSAPctxlist *ctxlist, OID defctxname, const int prequirements, const int srequirements, const long isn, int settings, struct SSAPref *ref, PE *data, int ndata, const struct QOStype *qos, struct AcSAPconnect *acc, struct AcSAPindication *aci, const int async);
