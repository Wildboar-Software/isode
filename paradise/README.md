...
`paradise-gen.8` (also formatted as `doc/COSINE`). Top-level Make
targets `paradise`, `paradise-dsa`, and `paradise-dua` build this
subset. Live `PARADISEDUA` is `others/quipu/uips/de` in the main tree;
those targets do not copy this overlay over it.
...
| [others/](others/README.md) | Packaged DE (kept beside stock) and IDM (no stock copy) |
