...
#include "namelist.h"
#include "destrings.h"
int listPRRRm(char *parentstr, char *thisstr, struct namelist **listp);
static int listAllPRRRm(char *parentstr, struct namelist **listp);
static int listMatchingPRRRm(char *parentstr, char *thisstr, struct namelist **listp);
static int listExactPRRRm(char *objectstr, struct namelist **listp);
static struct ds_search_arg *
fillMostPRRSearchArgRm(char *parentstr, int searchdepth);
...
struct ds_search_arg *fillMostPRRSearchArgRm(char *parentstr, int searchdepth);
...
int listAllPRRRm(char *parentstr, struct namelist **listp) {
	int ret;
...
int listMatchingPRRRm(char *parentstr, char *thisstr, struct namelist **listp) {
	VFP * filtarray;
	VFP filterfunc;
	int filtnumber;
...
int listExactPRRRm(char *objectstr, struct namelist **listp) {
	int ret;
