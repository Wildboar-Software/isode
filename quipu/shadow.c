...
extern struct oper_act * oper_alloc(void);
extern DN mydsadn;
extern LLog * log_dsap;
extern Entry entry_cpy(Entry entryptr);
extern Entry database_root;
extern char * new_version(void);
extern Attr_Sequence as_comp_cpy(Attr_Sequence as);
extern Attr_Sequence entry_find_type(Entry a, AttributeType b);
extern struct access_point * ap_cpy(const struct access_point *ap);
extern time_t timenow;
extern time_t	conn_timeout;
extern time_t	nsap_timeout;
extern Entry make_path(DN dn);
