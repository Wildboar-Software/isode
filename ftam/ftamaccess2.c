...
static int FAccessResponseAux (struct ftamblk *fsb, const int action, struct FADUidentity *identity, struct FTAMdiagnostic diag[], int ndiag, struct FTAMindication *fti);
