...
conctl2fpm (const struct ftamblk *fsb, struct FTAMconcurrency *fc, struct FTAMindication *fti) {
...
conacc2fpm (const struct ftamblk *fsb, struct FTAMconcurrency *fc, struct FTAMindication *fti) {
