...
--  date:     	4/89                                            *
--                                                              *
--  This is an abstract syntax module for presentation PCI.     *
...
-- HULA changed ./psap2/ps.py for connectionless service
-- no changes made to the ps.py header 
...
-- even though P-UNIT-DATA is a separate abstract syntax
-- to prevent dozens of duplicate encode/decode routines 
--

-- The value of the SS-user data parameter of the S-UNIT-DATA
-- request and indication session-service primitives shall be a UD-type value,
-- followed as a requestor's opstion by zero or more UDC-type values.
...
--
-- As an initiator's option, the presentation data values contained in a UD
-- PPDU may be encoded more than once, using UDC-type values, to allow the
	    ...
	    normal-mode --* *--
		        ...
		        INTEGER {
		            ...
		            no-PSAP-available(7)
                        ...
                        --* OPTIONAL *-- DEFAULT reason-not-specified,
