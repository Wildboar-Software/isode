...
/* settransfer */
/*--------------------------------------------------------------*/
int do_setreq (char **av) {
	do_settransfer(av, RI_TR_REQ);
}

int do_setauto (char **av) {
